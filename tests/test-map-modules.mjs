...
assert.equal(SOURCE_REGISTRY.SARA.contextPublication, "https://doi.org/10.1016/j.jsames.2020.102837");
assert.equal(SOURCE_REGISTRY.SARA.publicationLabel, "popup.saraDatasetCitation");
assert.equal(SOURCE_REGISTRY.ATA.publicationLabel, "popup.ataSourcePaper");
